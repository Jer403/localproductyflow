...
import { cleanSelected, nodeDoubleClickEvent, nodeMouseDownEvent, nodeMouseMoveEvent, nodeMouseUpEvent, nodeTouchMoveEvent, nodeTouchStartEvent, unselectTextArea } from "./events.js";
import { pushToHistorial } from "./historyUtils.js";
import { buildErrorLog, cleanSurface, editProjectName, getCurrentNetworkProject, hideModifiButtons, noProjectsFound, openSelectedProjectOrFirstProject, setActualProject, setIsSaveToTrue, showModifiButtons } from "./nwUtils.js";
...
export async function createProjectButtons(projects) {       //This needs the next one
